namespace rt {
    public class Camera {
        ...
        public Camera(Vector position, Vector direction, Vector up, double viewPlaneDistance, double viewPlaneWidth,
            double viewPlaneHeight, double frontPlaneDistance, double backPlaneDistance) {
            Position = position;
            Direction = direction;
            Up = up;
