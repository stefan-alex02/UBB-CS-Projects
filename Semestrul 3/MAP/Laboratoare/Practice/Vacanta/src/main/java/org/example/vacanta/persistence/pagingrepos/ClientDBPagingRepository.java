package org.example.vacanta.persistence.pagingrepos;
...
public class ClientDBPagingRepository extends PersonDBRepository implements PagingRepository<Long, Person, Long> {
    public ClientDBPagingRepository(DatabaseConnection databaseConnection) {
