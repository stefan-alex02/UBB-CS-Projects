...
import ro.mpp2024.persistence.configuration.ConfigurationHibernateRepository;
...
public class StartObjectServer {
    ...
    public static void main(String[] args) {
       Properties serverProps = new Properties();
        ...
        ConfigurationRepository configurationRepo = new ConfigurationHibernateRepository();

        GameServices chatServerImpl = new GameServicesImpl(userRepo, gameRepo, configurationRepo);
