...
public class GameServicesImpl implements GameServices {
    ...
    public GameServicesImpl(UserRepository userRepository,
                            GameRepository gameRepository, ConfigurationRepository configurationRepository) {
    ...
    public synchronized Game login(User user, GameObserver client) throws GameException {
        ...
        Optional<Configuration> optionalConfiguration = configurationRepository.getRandomConfiguration();
        if (optionalConfiguration.isEmpty()) {
            throw new GameException("No configuration found");
        }
